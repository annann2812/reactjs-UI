		...
		<div className="w-full flex flex-col">
			<div className="w-full bg-primary py-8 flex flex-col items-center justify-center gap-8">
				<div className="flex items-center">
					<span className="text-white font-semibold text-[40px]">Ann Cafe</span>
					<img
						src={leafIcon}
						alt="leafIcon"
						className="rotate-90"
					...
					<div className="flex flex-col gap-3">
						<div className="flex items-center gap-3">
							<img
								...
								alt="phone"
							/>
							<span className="text-white font-medium text-[15px]">+84-12345678</span>
						</div>
						<div className="flex items-center gap-3">
							<img
								src={loc}
			...
			<div className="w-full bg-darkFooter h-[57px] flex items-center justify-between lg:px-[100px] px-5">
				<span className="text-white text-[15px] z-50">
					All rights are resrved by Ann's Cafe. 2024
				</span>
